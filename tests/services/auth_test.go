...
import (
	...
	helperMocks "github.com/n0f4ph4mst3r/TokenCraft/tests/services/mocks/helpers"
	providerMocks "github.com/n0f4ph4mst3r/TokenCraft/tests/services/mocks/providers"
...
func TestRegisterUser(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			...
			authProviderMock := providerMocks.NewMockAuthProvider(t)
			hasherMock := helperMocks.NewMockHasher(t)
...
func TestLogin(t *testing.T) {
	...
	cases := []struct {
		...
		setup func(
			email string,
			appId int64,
			provider *providerMocks.MockAuthProvider,
			signer *helperMocks.MockTokenSigner,
			hasher *helperMocks.MockHasher,
		)
		...
		},
		{
			...
			setup: func(email string, appId int64, provider *providerMocks.MockAuthProvider, signer *helperMocks.MockTokenSigner, hasher *helperMocks.MockHasher) {
				provider.EXPECT().
					UserByEmail(mock.Anything, email).
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			...
			authProvider := providerMocks.NewMockAuthProvider(t)
			hasherMock := helperMocks.NewMockHasher(t)
			signerMock := helperMocks.NewMockTokenSigner(t)
...
func TestUpdateToken(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			...
			provider := providerMocks.NewMockAuthProvider(t)
			signer := helperMocks.NewMockTokenSigner(t)
			hasher := helperMocks.NewMockHasher(t)
