...
import (
	...
	"github.com/n0f4ph4mst3r/TokenCraft/tests/repo/mocks"
...
func TestUserById(t *testing.T) {
	...
	cases := []struct {
		...
		setupDB    func(db *mocks.MockDbProvider, id uuid.UUID)
		setupCache func(c *mocks.MockCacheProvider, key string)
...
func TestUserByEmail(t *testing.T) {
	...
	cases := []struct {
		...
		setupDB    func(db *mocks.MockDbProvider, email string)
		setupCache func(c *mocks.MockCacheProvider, key string)
...
func TestRegisterUser(t *testing.T) {
	...
	cases := []struct {
		...
		setupDB    func(db *mocks.MockDbProvider, email string, username string, hashPassword []byte)
		setupCache func(c *mocks.MockCacheProvider, idKey, emailKey string)
...
func TestRoleCheck(t *testing.T) {
	...
	cases := []struct {
		...
		setupDB    func(db *mocks.MockDbProvider, tokenHash string)
		setupCache func(c *mocks.MockCacheProvider, tokenKey, rolesKey string)
...
func TestAppById(t *testing.T) {
	...
	cases := []struct {
		...
		setupDB    func(db *mocks.MockDbProvider, id int64)
		setupCache func(c *mocks.MockCacheProvider, key string)
...
func TestSaveToken(t *testing.T) {
	...
	cases := []struct {
		...
		setupDB    func(db *mocks.MockDbProvider)
		setupCache func(c *mocks.MockCacheProvider, key string)
