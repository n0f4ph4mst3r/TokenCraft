...
const (
	...
	Auth_RoleCheck_FullMethodName    = "/auth.Auth/RoleCheck"
)
...
type AuthClient interface {
	...
	RoleCheck(ctx context.Context, in *RoleCheckRequest, opts ...grpc.CallOption) (*RoleCheckResponse, error)
}
...
func (c *authClient) RoleCheck(ctx context.Context, in *RoleCheckRequest, opts ...grpc.CallOption) (*RoleCheckResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RoleCheckResponse)
	err := c.cc.Invoke(ctx, Auth_RoleCheck_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServer interface {
	...
	RoleCheck(context.Context, *RoleCheckRequest) (*RoleCheckResponse, error)
...
func (UnimplementedAuthServer) RoleCheck(context.Context, *RoleCheckRequest) (*RoleCheckResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RoleCheck not implemented")
}
...
func _Auth_RoleCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RoleCheckRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).RoleCheck(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_RoleCheck_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).RoleCheck(ctx, req.(*RoleCheckRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RoleCheck",
			Handler:    _Auth_RoleCheck_Handler,
		},
	},
